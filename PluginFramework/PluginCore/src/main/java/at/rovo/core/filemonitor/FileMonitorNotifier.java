...
/**
 * <p><code>FileMonitorNotifier</code> is the worker object for the 
 * {@link FileMonitor}. It is executed on a regular basis defined by the
 * polling interval of {@link FileMonitor#FileMonitor(long, File)}.</p>
 * 
...
public class FileMonitorNotifier extends TimerTask
{
	...
	/**
	 * <p>Creates a new instance and initializes required fields.</p>
	 * 
	 * @param files A mapping of files or directories and a timestamp of their last
	 *              modification
	 * @param listener A set of objects that spark interest on file modifications
	...
	/**
	 * <p>Executes the monitoring of a defined directory</p>
	 */
	public void run()
	{
	...
	/**
	 * <p>Notifies all registered objects of a file modification</p>
	 * 
	 * @param file The file which has been modified
	 * @param fileAction The action that triggered the file modification
	 */
