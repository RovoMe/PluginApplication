...
/**
 * <p>PluginManager takes care of the loading of plug-ins in a specified 
...
{
	private static SimplePluginManager manager = null;
	
	private String pluginDir = null;
	protected Map<String, PluginMeta> pluginData = null;
	protected List<IPluginListener> listeners;
	
	protected PluginManager()
	{
		this.pluginData = new HashMap<String, PluginMeta>();
		this.listeners = new ArrayList<IPluginListener>();
	}
	...
	*/
	...
	public void reloadPlugin(File file)
	{
		try
		{
			...
			if (jarFile.getManifest() == null)
				throw new IllegalArgumentException("Archive does not have a MANIFEST/MANIFEST.MF-file");
			Attributes attributes = jarFile.getManifest().getMainAttributes();
			// releases the lock on the loaded jar file
			jarFile.close();
			
			String pluginClass = attributes.getValue("Plugin-Class").trim();
			attributes = null;
	...
	protected void reloadPlugin(String pluginName)
	{
		...
		try
		{
			...
			StrategyClassLoader<IPlugin> pluginLoader = new StrategyClassLoader<IPlugin>(this.getClass().getClassLoader(), strategy);
	...
	*/
	 ...
	 * file inside the MANIFEST-directory of the .jar- or .zip-file.</p>
