...
/**
 * <code>UnloadCommand</code> invokes unloading of a currently loaded {@link IPlugin}. It therefore either takes the
 * current Id of the loaded plug-in or the fully-qualified name of the plug-in.
 * <p/>
 * If no command was specified 'unload' is taken as default command.
 * <p/>
 * Examples:
 * <code>
 *     <ul>
...
{
    /**
     * Creates a new instance of this class and sets its command the {@link Console} will listen to to 'unload'.
     *
     * @param manager
    ...
    public void execute(String[] token)
    {
        ...
        {
            System.out.println(
                    "Invalid call! Usage: 'unload id' or 'unload plugin.name' where plugin.name is the name of the plugin to unload");
        }
        else
        {
            try
