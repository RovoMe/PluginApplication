 ...
 * execution can be triggered either by providing the current Id 
 * of the plug-in, as provided by {@link ListCommand} or by the
 * fully-qualified class name of the plug-in instance.</p>
 * <p>If no command was specified 'exec' is taken as default command.</p>
 * <p>Examples:</p>
 * <code>
 * <ul>
 * <li>exec 1</li>
...
public class ExecuteCommand extends ConsoleCommand
{
	 ...
	 * the {@link Console} will listen to to 'exec'.</p>
	 * 
